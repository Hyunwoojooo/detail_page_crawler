...
def test_cafe24_scopes_to_normal_list():
    html = """
    <html>
      <body>
        <div class="xans-product-listmain menu-ranking">
          <ul class="prdList swiper-wrapper">
            <li><a href="/product/detail.html?product_no=1&cate_no=1">Rank</a></li>
          </ul>
        </div>
        <div class="xans-product-listnormal ec-base-product">
          <ul class="prdList">
            <li><a href="/product/detail.html?product_no=2&cate_no=3490">Main</a></li>
          </ul>
        </div>
      </body>
    </html>
    """
    base_url = "https://shop.example.com/product/list.html?cate_no=3490&page=1"
    links = extract_product_links(html, base_url, "cafe24")
    urls = {link.url for link in links}

    assert "https://shop.example.com/product/detail.html?product_no=2&cate_no=3490" in urls
    assert "https://shop.example.com/product/detail.html?product_no=1&cate_no=1" not in urls
